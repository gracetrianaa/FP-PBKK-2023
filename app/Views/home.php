...
<html lang="en">
  <head>
    ...
    <link href="<?=base_url("lib/owlcarousel/assets/owl.carousel.css")?>" rel="stylesheet" />
  ...
  <body>
      ...
      <div class="container">
        ...
        <div class="owl-carousel testimonial-carousel">
          ...
          <div class="testimonial-item">
            <img
              class="position-relative rounded-circle bg-white shadow mx-auto"
              src="<?=base_url('img/testimonial-4.jpg')?>"
              style="
                width: 100px;
                height: 100px;
                padding: 12px;
    ...
    <script src="<?=base_url("lib/owlcarousel/owl.carousel.js")?>"></script>
