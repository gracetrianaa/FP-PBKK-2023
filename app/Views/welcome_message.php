  ...
  <body>
      ...
      <div class="menu">
        <ul>
          ...
          <li class="menu-item hidden">
            <a href="https://codeigniter4.github.io/userguide/" target="_blank"
              >Docs</a
            >
          </li>
          <li class="menu-item hidden">
    ...
    <div class="further">
      <section>
        ...
        <p>
          The User Guide contains an introduction, tutorial, a number of "how
          to" guides, and then reference documentation for the components that
          make up the framework. Check the
          <a href="https://codeigniter4.github.io/userguide" target="_blank"
            >User Guide</a
          >
          !
        ...
        <p>
          ...
          venues for the community members to gather and exchange ideas. View
          all the threads on
          <a href="https://forum.codeigniter.com/" target="_blank"
    ...
    <footer>
      ...
      <div class="copyrights">
        <p>
          &copy;
          <?= date('Y') ?>
          CodeIgniter Foundation. CodeIgniter is open source project released
